...
*/
#ifndef ZB_VENDOR_CFG_NRF52_ZBOSS_SDK_H
#define ZB_VENDOR_CFG_NRF52_ZBOSS_SDK_H 1
...
/* #define ZB_NRF_TRACE */
/* Call NRF_LOG_INIT(), NRF_LOG_DEFAULT_BACKENDS_INIT() and NRF_LOG_FLUSH() from ZBOSS kernel.
   Disable this define to call it from other places (application etc). */
#define ZB_ASYNC_TRACE_CONTROL
/* Call nrf_sdh_enable_request() from ZBOSS kernel.
   Disable this define to call it from other places (application etc). */
#define ZB_ENABLE_SOFTDEVICE_FROM_ZBOSS

/* Use NRF fstorage for NVRAM operations. */
#define ZB_NRF_USE_FSTORAGE
#define ZB_HAVE_USERIAL
...
/*
 * Uncomment the ZB_USE_BUTTONS define in order to use physical buttons.
 * If commented, actions performed by buttons are triggered at fixed time intervals.
 * See light_sample as an example
 */
...
#endif /* ZB_VENDOR_CFG_NRF52_ZBOSS_SDK_H */
